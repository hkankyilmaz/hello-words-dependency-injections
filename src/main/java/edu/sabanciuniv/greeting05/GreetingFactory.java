...
public class GreetingFactory implements Factory {
...

    {
        ...
        try {
            props.load(new FileInputStream("/Users/hakankarayilmaz/Documents/IntelliJ/hellow-words-dependency-injections/src/main/java/edu/sabanciuniv/greeting05/resources/application.properties"));
